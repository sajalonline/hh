...
const app = {
  ...
  ui: {
    ...
    generateTextileDataUrl(fabric, colorHex, badge) {
      const key = `${fabric}_${colorHex}_${badge}`;
      if (this.textileCache && this.textileCache[key]) {
        return this.textileCache[key];
      }
      ...
      if (!this.textileCache) {
        this.textileCache = {};
      }
      this.textileCache[key] = dataUrl;
      return dataUrl;
    },
        ...
        wizardBody.innerHTML = `
          ...
          <div class="grid-2" style="margin-bottom:1.25rem; gap:1.25rem 1rem;">
            <div class="form-group">
              ...
              <input type="text" id="co-name" class="form-input" placeholder="e.g. Aditi Sharma" value="${app.escapeHtml(app.state.checkoutData.name)}" required />
            </div>
            <div class="form-group">
              <label class="form-label">Phone Contact *</label>
              <input type="tel" id="co-phone" class="form-input" placeholder="e.g. +91 98765 43210" value="${app.escapeHtml(app.state.checkoutData.phone)}" required />
            </div>
            <div class="form-group" style="grid-column: span 2;">
              <label class="form-label">Email Address *</label>
              <input type="email" id="co-email" class="form-input" placeholder="e.g. aditi@gmail.com" value="${app.escapeHtml(app.state.checkoutData.email)}" required />
            </div>
            <div class="form-group" style="grid-column: span 2;">
              <label class="form-label">Delivery Address *</label>
              <textarea id="co-address" class="form-input" rows="3" placeholder="Apartment, Street name, City details..." required style="resize:none;">${app.escapeHtml(app.state.checkoutData.address)}</textarea>
            </div>
            <div class="form-group">
              <label class="form-label">Pincode (6-digit) *</label>
              <input type="text" id="co-pincode" class="form-input" placeholder="e.g. 272207" value="${app.escapeHtml(app.state.checkoutData.pincode)}" maxlength="6" required />
            </div>
            <div class="form-group">
            ...
            <div class="invoice-box" id="printable-invoice">
              ...
              <div style="margin-bottom:1rem;">
                ...
                <p style="font-size:0.85rem; color:var(--text-muted); line-height:1.4;">
                  <strong>${app.escapeHtml(app.state.checkoutData.name)}</strong><br/>
                  ${app.escapeHtml(app.state.checkoutData.address)}, Pincode: ${app.escapeHtml(app.state.checkoutData.pincode)}<br/>
                  Phone: ${app.escapeHtml(app.state.checkoutData.phone)} | Email: ${app.escapeHtml(app.state.checkoutData.email)}
                </p>
              </div>
                  ...
                  ${app.state.cart.map(item => `
                    <tr style="border-bottom:1px dashed rgba(200, 146, 42, 0.15);">
                      <td style="padding:0.5rem 0;">
                        ...
                        <span style="font-size:0.75rem; color:var(--text-muted);">Size: ${app.escapeHtml(item.size)} | Color: ${app.escapeHtml(item.color)} | Fabric: ${app.escapeHtml(item.fabric)}</span>
                      </td>
        ...
        <section class="section-padding container">
          ...
          <div class="collection-grid">
            <div class="collection-card col-span-3">
              <img src="images/coll_kurta.jpg" alt="Kurta Sets collection" loading="lazy" />
            ...
            <div class="collection-card col-span-3">
              <img src="images/coll_saree.jpg" alt="Varanasi Sarees collection" loading="lazy" />
              <div class="collection-card-overlay">
            ...
            <div class="collection-card col-span-2">
              <img src="images/coll_lehenga.jpg" alt="Festive Lehengas collection" loading="lazy" />
              <div class="collection-card-overlay">
            ...
            <div class="collection-card col-span-2">
              <img src="images/coll_dupatta.jpg" alt="Sheer Dupattas collection" loading="lazy" />
              <div class="collection-card-overlay">
            ...
            <div class="collection-card col-span-2">
              <img src="images/coll_festive.jpg" alt="Festive Summer Edit campaign" loading="lazy" />
              <div class="collection-card-overlay">
                ...
                return `
                  <div class="product-card">
                    <div class="product-card-img-wrap" onclick="window.location.hash='#/product/${p.id}'" style="cursor:pointer;">
                      <img src="${p.colors[0].images[0]}" alt="${p.name}" class="product-card-img" onerror="app.ui.handleImageError(this, '${p.fabric}', '${p.colors[0].hex}', '${p.badge}')" loading="lazy" />
        ...
        <section class="section-padding story-snippet">
          <div class="container story-grid">
            <div class="story-img-wrap">
              <img src="images/boutique_store.jpg" alt="Designer Hemlata at Zenjal Boutique" class="story-img" loading="lazy" />
        ...
        <section class="section-padding container">
          ...
          <div class="insta-grid">
            <div class="insta-item">
              <img src="images/insta_1.jpg" alt="Boutique client in Chanderi sets" loading="lazy" />
              <div class="insta-overlay">❤️ 412 | 💬 18</div>
            </div>
            <div class="insta-item">
              <img src="images/insta_2.jpg" alt="Varanasi silk sarees folding zoom details" loading="lazy" />
              <div class="insta-overlay">❤️ 289 | 💬 9</div>
            </div>
            <div class="insta-item">
              <img src="images/insta_3.jpg" alt="Hands embroidering gota patti borders" loading="lazy" />
              <div class="insta-overlay">❤️ 567 | 💬 31</div>
            </div>
            <div class="insta-item">
              <img src="images/insta_4.jpg" alt="Aesthetic setup of Indian boutique studio" loading="lazy" />
              <div class="insta-overlay">❤️ 380 | 💬 12</div>
            </div>
            <div class="insta-item">
              <img src="images/insta_5.jpg" alt="Pastel pink wedding lehenga flatlay" loading="lazy" />
            ...
            <div>
              ...
              <div class="shop-header-row">
                <div class="product-count">
                  ...
                  ${searchQ ? `matching "<strong>${app.escapeHtml(searchQ)}</strong>"` : ''}
              ...
              ${searchQ ? `
                <div style="margin-bottom: 1.5rem; display:flex; gap:0.5rem; align-items:center;">
                  ...
                  <span class="filter-tag active" style="font-size:0.7rem; padding: 0.2rem 0.6rem; display:inline-flex; align-items:center; gap:0.25rem;">
                    ${app.escapeHtml(searchQ)} <span onclick="app.render.setShopFilter('searchQuery', '')" style="cursor:pointer; font-weight:700;">✕</span>
                  </span>
                </div>
              ` : ''}
                ...
                ${related.map(r => `
                  <div class="product-card">
                    <div class="product-card-img-wrap" onclick="window.location.hash='#/product/${r.id}'" style="cursor:pointer;">
                      <img src="${r.colors[0].images[0]}" alt="${r.name}" class="product-card-img" onerror="app.ui.handleImageError(this, '${r.fabric}', '${r.colors[0].hex}', '${r.badge}')" loading="lazy" />
                    </div>
              ...
              ${p.reviews.length === 0 ? '<p style="font-style:italic; color:var(--text-muted);">No reviews written yet. Be the first to grace this garment!</p>' : p.reviews.map(r => `
                <div class="review-card">
                  <div class="review-card-header">
                    <strong class="review-author">${app.escapeHtml(r.author)}</strong>
                    <span class="review-date">${app.escapeHtml(r.date)}</span>
                  </div>
                  <div class="stars" style="margin-bottom:0.5rem;">${'★'.repeat(r.rating)}${'☆'.repeat(5-r.rating)}</div>
                  <p class="review-body">${app.escapeHtml(r.comment)}</p>
                </div>
              `).join('')}
            </div>
      ...
      container.innerHTML = `
        ...
        <section class="section-padding container">
          <div class="about-story-row">
            ...
            <div>
              <img src="images/weaving_loom.jpg" alt="Artisan handloom weaving chanderi silks" style="width:100%; border-radius:var(--radius-md); box-shadow:var(--shadow-warm); border:1px solid var(--border-gold);" loading="lazy" />
            </div>
          </div>
        </section>
          ...
          <div class="collections-edit-grid">
            <div class="edit-card">
              <div class="edit-card-img-wrap">
                <img src="images/coll_kurta.jpg" alt="Chanderi Kurta Sets Edit" loading="lazy" />
              </div>
            ...
            <div class="edit-card">
              <div class="edit-card-img-wrap">
                <img src="images/coll_saree.jpg" alt="Varanasi Katan Silk Sarees Edit" loading="lazy" />
              </div>
              <div class="edit-card-info">
                <div>
            ...
            <div class="edit-card">
              <div class="edit-card-img-wrap">
                <img src="images/coll_lehenga.jpg" alt="Bespoke Festive Lehengas Edit" loading="lazy" />
              </div>
              <div class="edit-card-info">
                <div>
            ...
            <div class="edit-card">
              <div class="edit-card-img-wrap">
                <img src="images/coll_dupatta.jpg" alt="Gota Patti Organza Dupattas Edit" loading="lazy" />
              </div>
              <div class="edit-card-info">
                <div>
            ...
            <div class="edit-card" style="grid-column: span 2;">
              <div class="edit-card-img-wrap" style="aspect-ratio: 16/9;">
                <img src="images/coll_festive.jpg" alt="Zenjal Festive Edit Campaign" style="object-position: center 30%;" loading="lazy" />
              </div>
